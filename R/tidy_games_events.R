...
#'
#' # Get events of both the 2021-01-13 MTL @ TOR and PIT @ PHI games with time remaining instead of
#' # time elapsed, as is coordinates instead of normalized, and keeping the IDs
#' tidy_games_events(
